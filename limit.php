...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">극한직업 </h1>
            <div class="contents1"> 코미디
                <div class="service">
                    <div>
                        <img src="img/limit.jpg" class="poster-info">
                    </div>

                    <div class="contents2">
                        <h2 class="heading-grade">관람객 평점 7.4</h2>

                        <h4>낮에는 치킨장사! 밤에는 잠복근무!
                        <br>지금까지 이런 수사는 없었다!</h4>

                        <div style="font-size:15px;">
                            <br><p>창불철주야 달리고 구르지만 실적은 바닥, 급기야 해체 위기를 맞는 마약반!</p>
                            <p>더 이상 물러설 곳이 없는 팀의 맏형 고반장은 국제 범죄조직의 국내 마약 밀반입 정황을 포착하고 장형사, 마형사, 영호, 재훈</p>
                            <p>까지 4명의 팀원들과 함께 잠복 수사에 나선다.</p>
                            <p>마약반은 24시간 감시를 위해 범죄조직의 아지트 앞 치킨집을 인수해 위장 창업을 하게 되고, 뜻밖의 절대미각을 지닌 마형</p>
                            <p>사의 숨은 재능으로 치킨집은 일약 맛집으로 입소문이 나기 시작한다.</p>
                            <p>수사는 뒷전, 치킨장사로 눈코 뜰 새 없이 바빠진 마약반에게 어느 날 절호의 기회가 찾아오는데…</p>                       
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/limit.mp4" class = "video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/limit-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/limit-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/limit-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/byeonhunlee.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/sengryoung.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                        고반장 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/hanye.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                        장형사 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/sunkgu.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                        마형사 역
                        </div>
                        <div class="movie-name">
