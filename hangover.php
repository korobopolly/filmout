...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">행오버</h1>
            <div class="contents1"> 코미디
                <div class="service">
                    <div>
                        <img src="img/hangover.jpg" class="poster-info">
                    </div>

                    <div class="contents2">
                        <h2 class="heading-grade">관람객 평점 7.9</h2>

                        <div style="font-size:15px;">
                            <br><p>더그의 결혼식을 앞두고 친구 세 명은 함께 라스베가스로 총각 파티를 떠난다. 멋진 호텔에서 한껏 즐거운 밤을 보낸 이들은</p>
                            <p>아침에 친구인 더그가 사라진 사실을 알게 된다. 아무 생각도 해낼 수 없던 이들은 지난 밤 만났던 사람들에게 친구를 수소문</p>
                            <p>하고 우여곡절끝에 그를 결혼식장에 데려간다.</p>
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/hangover.mp4" class = "video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/hangover-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/hangover-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/hangover-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/todd.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/cooper.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                        필 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/edhams.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                        스투 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/jah.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                        앨런 역
                        </div>
                        <div class="movie-name">
