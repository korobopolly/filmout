...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">파이프라인</h1>
            <div class="contents1"> 범죄
                <div class="service">
                    <div>
                        <img src="img/pipe.jpg" class="poster-info">
                    </div>

                    <div class="contents2">
                        <h2 class="heading-grade">관람객 평점 6.5</h2>

                        <h4>목표는 하나, 목적은 여섯! </h4>
                        <h4>화끈하게 뚫고, 완벽하게 빼돌려라! </h4>

                        <div style="font-size:15px;">
                            <br><p>손만 대면 대박을 터트리는 도유 업계 최고 천공기술자 ‘핀돌이’는</p>
                            <p>수천억의 기름을 빼돌리기 위해 거대한 판을 짠 대기업 후계자 ‘건우’의</p>
                            <p>거부할 수 없는 제안에 빠져 위험천만한 도유 작전에 합류한다.</p>
                            <p>인생 역전을 꿈꾸는 여섯 명의 도유꾼들​</p>
                            <p>그들의 막장 팀플레이가 시작된다!</p>
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/pipe.mp4" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/pipe-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/pipe-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/pipe-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/youha.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/ingook.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            핀돌이 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/soo-heok.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                            건우 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/moon-seok.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            접새 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/seng-mok.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            나 과장 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/tae.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            근 사브 역
                        </div>
                        <div class="movie-name">
