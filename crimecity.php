...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">범죄 도시</h1>
            <div class="contents1"> 범죄 / 드라마
                <div class="service">
                    <div>
                        <img src="img/crimecity.jpg" class="poster-info">
                    </div>
                    ...
                    <div class="contents2">
                        ...
                        <h4>“오늘 밤, 다 쓸어버린다!”</h4>
                        <h4>올 추석, 나쁜 놈들 때려잡는 강력반 형사들의 ‘조폭소탕작전’이 시작된다!</h4>

                        <div style="font-size:15px;">
                            <br>도시 일대의 최강자로 급부상한 신흥범죄조직의 악랄한 보스 ‘장첸(윤계상)’.
                            <p>대한민국을 뒤흔든 ‘장첸(윤계상)’ 일당을 잡기 위해 </p>
                            <p>직 주먹 한방으로 도시의 평화를 유지해 온 괴물형사 ‘마석도(마동석)’와</p>
                            <p>인간미 넘치는 든든한 리더 ‘전일만(최귀화)’ 반장이 이끄는 강력반은</p>
                            <p>나쁜 놈들을 한방에 쓸어버릴 끝.짱.나.는. 작전을 세우는데…</p>
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/crimecity.mp4" class = "video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/crimecity-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/crimecity-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/crimecity-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/yoon-sung.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/dong-suck.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            마석도 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/gae-sang.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            장첸 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/jae-yoon.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                            황사장 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/sun-geun.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            위성락 역  
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/hwa.jpg" alt="" class= "poster-actor">
                        <div class="movie-genre">
                            전반장 역
                        </div>
                        <div class="movie-name">
