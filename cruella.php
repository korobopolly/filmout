...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">크루엘라</h1>
            <div class="contents1"> 드라마 / 범죄 / 코미디
                <div class="service">
                    <div>
                        <img src="img/cruella.jpg" class="poster-info">
                    </div>

                    <div class="contents2">
                        <h2 class="heading-grade">관람객 평점 8.6</h2>

                        <h4>처음부터 난 알았어. 내가 특별하단 걸</h4>

                        <div style="font-size:15px;">
                            <br><p>그게 불편한 인간들도 있겠지만 모두의 비위를 맞출 수는 없잖아?</p>
                            <p>그래서 난 내가 누군지 보여주기로 했어</p>
        ...
        <div class="trailer-detail">
            <video src="trailer/cruella.mp4" class="video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/cruella-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/cruella-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/cruella-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/craig.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/thompson.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            남작 부인 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/mark.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            존 역
                        </div>
                        <div class="movie-name">
