...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">더 넌</h1>
            <div class="contents1"> 호러 
                <div class="service">
                    <div>
                        <img src="img/nun.jpg" class="poster-info">
                    </div>
                    ...
                    <div class="contents2">
                        ...
                        <div style="font-size:15px;">
                            <br>루마니아의 젊은 수녀가 자살하는 사건을 의뢰 받아 바티칸에서 파견된 버크 신부와 아이린 수녀가 
                            <p>수녀원을 조사하면서 충격적인 악령의 실체와 만나게 되는 이야기를 그린다 </p>
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/nun.mp4" class = "video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/nun-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/nun-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/nun-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/corin.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/taissa.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            아이린 수녀 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/demian.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            버크 신부 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/bony.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            악마 수녀 역   
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/hope.jpg" alt="" class= "poster-actor">
                        <div class="movie-genre">
                            빅토리아 수녀 역
                        </div>
                        <div class="movie-name">
