...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first"> 베놈 2 : 렛 데어 비 카니지 </h1>
            <div class="contents1"> 액션 / SF / 스릴러
                <div class="service">
                    <div>
                        <img src="img/venom.jpg" class="poster-info">
                    </div>
                    ...
                    <div class="contents2">
                        ...
                        <div style="font-size:15px;">
                            <br>`베놈`과 완벽한 파트너가 된 `에디 브록`(톰 하디) 앞에 
                            <p>`클리터스 캐서디`(우디 해럴슨)가 `카니지`로 등장</p>
                            <p>앞으로 닥칠 대혼돈의 세상을 예고한다.</p>
        ...
        <div class="trailer-detail">
            <video src="trailer/venom.mp4" class = "video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/venom-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/venom-cut02.webp" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/venom-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/serkis.jfif" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/tom.jfif" alt="" class="poster-actor">
                        <div class="movie-genre">
                            에디 브록 역
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/williams.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            앤 웨잉 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/scott.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            댄 루이드 박사 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/graham.jpg" alt="" class= "poster-actor">
                        <div class="movie-genre">
                            멀리건 형사 역
                        </div>
                        <div class="movie-name">
