...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">해피 버스데이</h1>
            <div class="contents1"> 호러 / 스릴러
                <div class="service">
                    <div class="the spy_poster">
                        <img src="img/happy.jpg" height="430" width="400">
                    </div>
                    ...
                    <div class="contents2">
                        ...
                        <div style="font-size:15px;">
                            <br>생일날 반복되는 죽음이라는 특별한 선물을 받은 여대생의 끝나지 않는 파티
                        </div>
        ...
        <div class="trailer-detail">
            <video src="trailer/happy.mp4" class="video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/happy-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/happy-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/happy-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/rendon.jpg" alt="" class="poster-actor">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/jessica.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            트리 겔브만  역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/brusad.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            카터 베이비스 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/ruby.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                           로리 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/matues.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                            다니엘 역 
                        </div>
                        <div class="movie-name">
