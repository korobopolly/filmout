...
<html lang="en">
    ...
    <body>
        ...
        <div class="main_text1">
            <h1 class="heading-first">어스</h1>
            <div class="contents1"> 스릴러 / 호러
                <div class="service">
                    <div class="the spy_poster">
                        <img src="img/us.jpg" height="430" width="400">
                    </div>

                    <div class="contents2">
                        <h2 class="heading-grade">관람객 평점 7.7</h2>

                        <h4><h4>전세계를 뒤흔든 <겟 아웃> 조던 필 감독의 영리한 문제작!</h4></h4>
                        <h4>우리는 누구인가?</h4>
        ...
        <div class="trailer-detail">
            <video src="trailer/us.mp4" class="video-info" controls autoplay muted></video>
        </div>
        ...
        <section class="section-top3">
            <div class="row">
                <div class="col-1-of-3">
                    <div class="poster">
                       <img src="img/us-cut.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/us-cut02.jpg" alt="" class="still-cut">
                    </div>
                </div>

                <div class="col-1-of-3">
                    <div class="poster">
                        <img src="img/us-cut03.jpg" alt="" class="still-cut">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-top3">
            <div class="row">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/lupita.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            애들레이드 윌슨 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/winston.jpeg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            게이브 윌슨 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/joseph.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                            조라 윌슨 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/evan.png" alt="" class="poster-actor">
                        <div class="movie-genre">
                            제이슨 윌슨 역 
                        </div>
                        <div class="movie-name">
                ...
                <div class="col-1-of-6">
                    <div class="poster">
                        <img src="img/cali.jpg" alt="" class="poster-actor">
                        <div class="movie-genre">
                            베카 타일러 역
                        </div>
                        <div class="movie-name">
